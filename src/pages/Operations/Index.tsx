                ...
                <TabsContent value="overview" className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {sops.map((sop) => {
                            ...
                            const Icon = sop.icon;
                            return (
                                <Card key={sop.id} className="bg-card/50 border-border hover:border-primary/30 transition-all group">
                                    <CardHeader>
                    ...
                    {!activeSOP ? (
                        <Card className="bg-card/50 border-dashed">
                            <CardContent className="flex flex-col items-center justify-center py-16">
                                ...
                                <p className="text-lg font-medium mb-2">Nenhum SOP selecionado</p>
                                ...
                                <CardContent className="p-6">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <h2 className="text-2xl font-bold">{activeSOP.title}</h2>
                            ...
                            {getSOPProgress(activeSOP) === 100 && (
                                <Card className="bg-green-500/10 border-green-500/20">
                                    <CardContent className="p-6 flex items-center gap-4">
                                        ...
                                        <Button variant="outline" className="ml-auto" onClick={() => setActiveTab('overview')}>
