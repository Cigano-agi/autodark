...
import { Loader2, Wand2, Play, Image as ImageIcon, FileText, CheckCircle, Zap } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-in relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        {selectedChannelId && blueprint && (
                            <div className="p-3 bg-primary/10 rounded-lg text-sm space-y-2 border border-primary/20">
                                ...
                                <ul className="space-y-1 text-muted-foreground text-xs">
                                    <li><span className="font-semibold text-foreground">Tópico:</span> {blueprint.topic || '-'}</li>
                                    <li><span className="font-semibold text-foreground">Voz:</span> {blueprint.voice_name || '-'}</li>
                                    <li><span className="font-semibold text-foreground">Estilo:</span> {blueprint.visual_style ? 'Definido' : '-'}</li>
                                </ul>
                            </div>
                        )}
                    </CardContent>
                ...
                <div className="md:col-span-2 space-y-6">
                    ...
                    {/* Step 1: Script */}
                    <Card className={`transition-all duration-300 ${step === 1 ? 'ring-2 ring-primary border-transparent' : ''}`}>
                        <CardHeader>
                        ...
                        <CardContent>
                            {!script ? (
                                ...
                                <div className="space-y-4">
                                    <Textarea value={script} readOnly className="h-[200px] font-mono text-sm" />
                    ...
                    {/* Step 2: Audio */}
                    {step >= 2 && (
                        <Card className={`transition-all duration-300 animate-in fade-in slide-in-from-bottom-4 ${step === 2 ? 'ring-2 ring-primary border-transparent' : ''}`}>
                            <CardHeader>
                                <CardTitle className="flex items-center gap-2">
                                    ...
                                    <div className="p-4 bg-secondary/50 rounded-lg flex items-center justify-between border border-border">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="text-sm">
                                                <p className="font-medium">Audio_Gerado_v1.mp3</p>
                    ...
                    {/* Step 3: Thumbnail */}
                    {step >= 3 && (
                        <Card className={`transition-all duration-300 animate-in fade-in slide-in-from-bottom-4 ${step === 3 ? 'ring-2 ring-primary border-transparent' : ''}`}>
                            <CardHeader>
                                <CardTitle className="flex items-center gap-2">
                    ...
                    {step === 4 && (
                        <div className="flex justify-end animate-in fade-in slide-in-from-bottom-4">
                            <Button size="lg" className="w-full md:w-auto bg-green-600 hover:bg-green-700 text-white shadow-lg shadow-green-900/20">
